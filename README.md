...
| `suggest`   | `function` | Greedy match, returns the choices whose message contains the input string. | Function that filters choices. Takes user input and a choices array, and returns a list of matching choices. |
