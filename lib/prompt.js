...
const ansi = require('./styles/ansi');
...
class Prompt extends Events {
  ...
  start() {
    if (!this.stop && this.options.show !== false) {
      ...
      let resize = this.emit.bind(this, 'resize');
      this.stdout.on('resize', resize);
      this.on('close', () => {
        this.stdout.removeListener('resize', resize);
        this.stop();
      });
    }
  }
  ...
  async before() {
    if (typeof this.options.before === 'function') {
      return this.options.before.call(this, this);
    }
  }

  async after() {
    if (typeof this.options.after === 'function') {
      return this.options.after.call(this, this);
    }
  }
  ...
  prefix() {
    return elements.prefix(this);
  }

  message() {
    return elements.message(this);
  }

  separator() {
    return elements.separator(this);
  }
  ...
  get height() {
    return this.options.rows || utils.height(this.stdout);
  }
  get width() {
    return this.options.columns || utils.width(this.stdout);
  }
  get size() {
