...
import { equals, isTruthy } from './assert.js';

import createPrompt from './prompt.js';
import createEnquirerTypes from './types/index.js';
import createEnquirerPrompts from './prompts/index.js';

export default function createEnquirer(platformShims) {
  const enquirerTypes = createEnquirerTypes(platformShims);
  const enquirerPrompts = createEnquirerPrompts(platformShims);
  ...
  class Enquirer extends platformShims.EventEmitter {
    ...
    static get Prompt() {
      return this._Prompt || createPrompt(platformShims);
    }
    ...
    static get prompt() {
      ...
      utils.mixinEmitter(fn, new platformShims.EventEmitter());
      return fn;
    }
  }

  utils.mixinEmitter(Enquirer, new platformShims.EventEmitter());
