...
class ArrayPrompt extends Prompt {
  ...
  space() {
    return actions.array.space(this);
  }
  ...
  first() {
    return actions.array.first(this);
  }

  last() {
    return actions.array.last(this);
  }

  prev() {
    return actions.array.prev(this);
  }

  next() {
    return actions.array.next(this);
  }
