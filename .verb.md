...
Thanks to [derhuerst](https://github.com/derhuerst), creator of [prompt-skeleton][] and other prompt libraries that influenced some of the concepts we used in our prompts.
